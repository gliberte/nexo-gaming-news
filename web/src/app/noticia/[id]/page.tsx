  ...
  return (
    <main className="container" style={{ maxWidth: hasVerticalVideo ? '1150px' : '800px', transition: 'max-width 0.3s ease-in-out' }}>
      ...
      <div className="article-layout" style={{ 
        ...
        {hasVerticalVideo && (
          <aside className="video-aside border border-outline-variant rounded-xl p-4 space-y-4" style={{
            ...
            <p className="text-[11px] text-center text-on-surface-variant font-mono" style={{ margin: 0 }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* Responsive para el grid de video */
